...
const   SellerMembershipPayment = () => {
    ...
    const membershipAmount = selectedMembership === 'sell-rent' ? 1700 : 1000; // Determine price based on selection
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Send payment details and membership info to the backend for sellers
            await axios.post(
                'http://localhost:5000/addSellerMembership',
                {
            ...
            <div className='fake-container'>
                ...
                <div className="payment-container">
                    <div className="payment-form-details">
                        <h2>Make Your Payment to Get Seller Membership</h2><br />
...
export default SellerMembershipPayment;
