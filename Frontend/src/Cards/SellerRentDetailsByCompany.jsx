...
const SellerRentDetails = ({ vehicle }) => {
    ...
    return (
        <div className="rent-card">
            ...
            <div className="rent-card-detail">
                    <strong>Rental Company Username:</strong> {vehicle.rental_company_username}
                </div>
                <div className="rent-card-detail">
                ...
                <div className="rent-card-detail">
                    <strong>Email:</strong> {vehicle.rental_company_email}
                </div>
                <div className="rent-card-detail">
...
export default SellerRentDetails;
